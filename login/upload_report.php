...
?>
    ...
    <div class="row w3-res-tb" style="margin-left:5px; min-height:400px;" > 
        ...
        <select class="input-sm form-control w-sm inline v-middle" name="cid" style="width:215px;" onchange="getProject('findproject.php?cid='+this.value)" required>
        <option value=''> &nbsp; &nbsp; &nbsp; - - &nbsp; Select Client Name &nbsp; - - </option>
		  ...
		  {
		  ?>
          <option value="<?PHP echo $cli_data['id']; ?>" <?PHP if($_REQUEST['cid']==$cli_data['id']) { ?> selected <?PHP } ?>><?PHP echo $cli_data['name']; ?> [<?PHP echo $cli_data['email']; ?>]</option>
          <?PHP } ?>
        </select>
        </div>
...
<select class="input-sm form-control w-sm inline v-middle" name="pid" style="width:215px;" onchange="getUploadedRecord('finduploadedrecord.php?pid='+this.value)" required>
...
{
?>
<option value="<?PHP echo $cli_data['id']; ?>" <?PHP if($cli_data['id']==$_REQUEST['pid']) { ?> selected <?PHP } ?>><?PHP echo $cli_data['projectName']; ?> </option>
<?PHP } ?>
</select>  
   ...
   <div class="panel-body">
                        ...
                        <span class="text-inverse" style=" font-size:14px;">*** Upload only <strong>pdf,doc,docx,xls,xlsx</strong> file.<br /><br /></span>
                        </div>
                        </div>
...
<option value="Document Links">Document Links </option>
                        ...
                        <input name="img1" type="file" id="img1" class="form-control" onChange="validateFileSize39(this.id,'dvMsg_39');" /> 
                        </div>
                        </div>
<div id="dvMsg_39" style="background-color:#c91822; color:White; font-size:12px;  width:200px; padding:3px; margin-top: -18px; margin-bottom: 10px; text-align:center; display:none;" >
<span class="jpg_pdf" style="color:#000; text-align:center;">Max. size is 2 MB</span></div>
<div id="ErrorLabel_39" style="background-color:#c91822; text-align:center; color:White; font-size:12px;  width:200px; padding:3px; margin-top: -18px; margin-bottom: 10px; display:none;"><span class="jpg_pdf" style="color:#fff; text-align:center;">Invalid file format</span></div>
<div id="SucessLabel_39" style="background-color:#53741d; text-align:center; color:White; font-size:12px;  width:200px; padding:3px; margin-top: -18px; margin-bottom: 10px; display:none;"><span class="jpg_pdf" style="color:#fff; text-align:center;">File Selected</span></div> 
						</div>
                        </div>
                       ...
                       <div style="clear:both;"></div>
                        ...
                        <span class="input-group-addon btn-white"><i class="fa fa-cloud-upload text-inverse"></i></span>
                        <div class="wrap-input100 validate-input m-b-23">
                        <input name="img2" type="file" id="img2" class="form-control" onChange="validateFileSize40(this.id,'dvMsg_40');" />                     
                        </div>
                        </div>
<div id="dvMsg_40" style="background-color:#c91822; color:White; font-size:12px;  width:200px; padding:3px; margin-top: -18px; margin-bottom: 10px; text-align:center; display:none;" >
<span class="jpg_pdf" style="color:#000; text-align:center;">Max. size is 2 MB</span></div>
<div id="ErrorLabel_40" style="background-color:#c91822; text-align:center; color:White; font-size:12px;  width:200px; padding:3px; margin-top: -18px; margin-bottom: 10px; display:none;"><span class="jpg_pdf" style="color:#fff; text-align:center;">Invalid file format</span></div>
<div id="SucessLabel_40" style="background-color:#53741d; text-align:center; color:White; font-size:12px;  width:200px; padding:3px; margin-top: -18px; margin-bottom: 10px; display:none;"><span class="jpg_pdf" style="color:#fff; text-align:center;">File Selected</span></div> 
						</div>
                        </div>
                        ...
                        <span class="input-group-addon btn-white"><i class="fa fa-cloud-upload text-inverse"></i></span>
                        <div class="wrap-input100 validate-input m-b-23">
                        <input name="img3" type="file" id="img3" class="form-control" onChange="validateFileSize41(this.id,'dvMsg_41');" />   
                        </div>
                        </div>  
<div id="dvMsg_41" style="background-color:#c91822; color:White; font-size:12px;  width:200px; padding:3px; margin-top: -18px; margin-bottom: 10px; text-align:center; display:none;" >
<span class="jpg_pdf" style="color:#000; text-align:center;">Max. size is 2 MB</span></div>
<div id="ErrorLabel_41" style="background-color:#c91822; text-align:center; color:White; font-size:12px;  width:200px; padding:3px; margin-top: -18px; margin-bottom: 10px; display:none;"><span class="jpg_pdf" style="color:#fff; text-align:center;">Invalid file format</span></div>
<div id="SucessLabel_41" style="background-color:#53741d; text-align:center; color:White; font-size:12px;  width:200px; padding:3px; margin-top: -18px; margin-bottom: 10px; display:none;"><span class="jpg_pdf" style="color:#fff; text-align:center;">File Selected</span></div>     
						</div>
                        </div>
                        ...
                        <div class="col-lg-3">               
                        <div class="input-group m-bot15">
						<div class="wrap-input50 validate-input m-b-23" data-validate = "Project start date is required">
						<input type="text" class="form-control input100" name="reportdate" id="demo" style="width:160px;" required >
						</div><br />
...
<td><a href="reports/<?PHP echo $user_data['imgPath']; ?>" target="_blank" download><i class="fa  fa-download text-inverse" title="Download Report" style="font-size:15px;"></i></a>&nbsp;&nbsp;&nbsp;
<a href="reports/<?PHP echo $user_data['imgPath']; ?>" target="_blank"><i class="fa  fa-eye text-success" title="View Report" style="font-size:15px;"></i></a>&nbsp;&nbsp;&nbsp;
<a href="upload_report.php?action=delete&rid=<?PHP echo $user_data['id']; ?>&cid=<?PHP echo $cid; ?>&pid=<?PHP echo $pid; ?>" onclick="return confirm('Are you sure you want to delete this record?');"><i class="fa fa-times-circle text-danger text" style="font-size:15px; cursor:pointer;"></i></a></td>
</tr>
<?PHP 
$i=$i+1;
} ?>
