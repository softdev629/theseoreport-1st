      ...
      <table class="table table-striped b-t b-light">
        <thead>
          <tr>
            <th>S.N.</th>
            <th>Stopped Project 
<a href="projectstopped.php?orderby=DESC&page=<?php echo $page;?>&usertype=<?php echo $projecttype;?>&searchkeyword=<?php echo $searchkeyword;?>&orderfield=projectName&mode=show"><span style="font-size:19px;">&nbsp <i class="fa fa-sort-alpha-desc text-inverse" title="Descending Order"></i></span></a>
<a href="projectstopped.php?orderby=ASC&page=<?php echo $page;?>&usertype=<?php echo $projecttype;?>&searchkeyword=<?php echo $searchkeyword;?>&orderfield=projectName&mode=show"><span style="font-size:19px;">&nbsp <i class="fa fa-sort-alpha-asc text-success" title="Ascending Order"></i></span></a>              </th>
            <th>Package</th>
            <th>&nbsp;</th>
            <th>&nbsp;</th>
            </tr>
...
<strong>Start:</strong>&nbsp;&nbsp; <?PHP echo $newstartdate; ?>  <br />
<strong>Stop:</strong>&nbsp;&nbsp;&nbsp; <?PHP echo $newstopdate; ?>  </td>
<td><?PHP echo ucwords($pack_data['name']); ?></td>
<td>
  <form id="forma<?PHP echo $i; ?>" name="forma<?PHP echo $i; ?>" action="projectstopped.php?mode=edit" method="post">
  ...
  <td>
  <a href="projectstopped.php?action=delete&pid=<?PHP echo $project_data['id']; ?>" onclick="return confirm('Are you sure you want to delete this record?');"><i class="fa fa-times-circle text-danger text" style="font-size:25px; cursor:pointer;"></i></a></td>
</tr>
<?PHP 
$i=$i+1;
} ?>
  ...
  <section class="panel">
                ...
                <form class="form-horizontal bucket-form login100-form validate-form" method="post" action="projectstopped.php?action=add">
...
?> 
  <section class="panel">
                        ...
                        <div class="panel-body">
                        <div align="center" style="margin-bottom:30px;" class="text-danger"><?PHP echo $message; ?></div>
                <form class="form-horizontal bucket-form login100-form validate-form" method="post" action="projectstopped.php?action=edit">
