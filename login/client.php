...
<a href="client.php?orderby=ASC&page=<?php echo $page;?>&searchkeyword=<?php echo $searchkeyword;?>&orderfield=name&mode=show"><span style="font-size:19px;">&nbsp <i class="fa fa-sort-alpha-asc text-success" title="Ascending Order"></i></span></a>              </th>
            <th>Username / Email
...
<a href="client.php?orderby=ASC&page=<?php echo $page;?>&usertype=<?php echo $usertype;?>&searchkeyword=<?php echo $searchkeyword;?>&orderfield=email&mode=show"><span style="font-size:19px;">&nbsp <i class="fa fa-sort-alpha-asc text-success" title="Ascending Order"></i></span></a>            </th>
            <th>Phone</th>
            <th>Status</th>
            <th>&nbsp;</th>
            <th>&nbsp;</th>
...
<td>
<a href="client.php?action=delete&uid=<?PHP echo $user_data['id']; ?>" onclick="return confirm('Are you sure you want to delete this record?');"><i class="fa fa-times-circle text-danger text" style="font-size:25px; cursor:pointer;"></i></a></td>
</tr>
<?PHP 
$i=$i+1;
} ?>
