...
<a href="project.php?orderby=ASC&page=<?php echo $page;?>&usertype=<?php echo $projecttype;?>&searchkeyword=<?php echo $searchkeyword;?>&orderfield=projectName&mode=show"><span style="font-size:19px;">&nbsp <i class="fa fa-sort-alpha-asc text-success" title="Ascending Order"></i></span></a>              </th>
            <th>Package</th>
            <th>&nbsp;</th>
            <th>&nbsp;</th>
            </tr>
...
<strong>Start:</strong>&nbsp;&nbsp; <?PHP echo $newstartdate; ?>   </td>
...
<td>
  ...
  <td>
  <a href="project.php?action=delete&pid=<?PHP echo $project_data['id']; ?>" onclick="return confirm('Are you sure you want to delete this record?');"><i class="fa fa-times-circle text-danger text" style="font-size:25px; cursor:pointer;"></i></a></td>
</tr>
<?PHP 
$i=$i+1;
} ?>
